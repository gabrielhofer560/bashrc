...
__conda_setup="$('/home/gabe/numpy/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/gabe/numpy/etc/profile.d/conda.sh" ]; then
        . "/home/gabe/numpy/etc/profile.d/conda.sh"
    else
        export PATH="/home/gabe/numpy/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
alias jn="jupyter-notebook --browser firefox progress.ipynb &"

function tex_template(){
  echo "
